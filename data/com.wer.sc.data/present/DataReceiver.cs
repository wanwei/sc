...
namespace com.wer.sc.data.present
{
    ...
    public class DataReceiver
    {
        ...
        private void OnReturnInstrument(object sender, ref List<InstrumentInfo> instruments)
        {
        ...
        private void SaveInstruments(List<InstrumentInfo> instruments)
        {
            JsonUtils_Instrument.Save(marketPath + "Instruments_" + this.tradingDay + ".json", instruments);
        }

        private List<InstrumentInfo> LoadInstruments()
        {
        ...
        private string[] GetCodes(List<InstrumentInfo> instruments)
        {
