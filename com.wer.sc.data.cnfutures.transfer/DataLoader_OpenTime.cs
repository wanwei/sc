...
namespace com.wer.sc.data.cnfutures.generator
{
    ...
    /// 该装载器可以得到
    /// </summary>
    public class DataLoader_OpenTime : IOpenTimeReader
    {
        ...
        public DataLoader_OpenTime(DataLoader_CodeInfo dataLoader_CodeInfo)
        {
        ...
        {
            return dataLoader_CodeInfo.GetBelongMarket(code);
        }

        private String GetVariety(String code)
        {
            return dataLoader_CodeInfo.GetVariety(code);
        }
    ...
    public class OpenTimeMarket
    {
        ...
        public DataLoader_OpenTime dataLoader;
