...
namespace com.wer.sc.data.transfer
{
    ...
    public class DataTransfer_KLine2KLine
    {
        ...
        /// <returns></returns>
        public static IKLineData Transfer_Day(IKLineData data, KLinePeriod targetPeriod, IDayStartTimeReader startTimeReader)
        {
        ...
        private static IKLineData Transfer_SrcIs1Minute(IKLineData data, KLinePeriod targetPeriod, IDayStartTimeReader startTimeReader)
        {
            KLinePeriod sourcePeriod = data.Period;
