...
{
    public class RealTimeDataNavigater_Tick
    {
        ...
        public RealTimeDataNavigater_Tick(DataReaderFactory dataReaderFactory, string code, int startDate, int endDate, Dictionary<KLinePeriod, KLineData_RealTime> dicKLineData)
        {
            Init(dataReaderFactory, code, startDate, endDate, dicKLineData);
            InitTimeByDate(dataReaderFactory, code, startDate);
        }

        public RealTimeDataNavigater_Tick(DataReaderFactory dataReaderFactory, string code, int startDate, int endDate, Dictionary<KLinePeriod, KLineData_RealTime> dicKLineData, double time)
        {
            Init(dataReaderFactory, code, startDate, endDate, dicKLineData);
            InitTime(time);
        }
        ...
        private void ForwardKLineData_NextDay(int nextDate, KLinePeriod period, KLineData_RealTime klineData)
        {
            ...
            RealTimeDataNavigateUtils.ForwardKLineDataToNextDayOpenTime(klineData, todayTickData, dataReaderFactory, tmpBar);
        }
