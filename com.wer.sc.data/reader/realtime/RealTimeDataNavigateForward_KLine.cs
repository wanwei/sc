...
namespace com.wer.sc.data.reader.realtime
{
    ...
    /// </summary>
    public class RealTimeDataNavigateForward_KLine: IRealTimeDataNavigateForward
    {
        ...
        public RealTimeDataNavigateForward_KLine(DataReaderFactory fac, string code, int startDate, int endDate, KLinePeriod defaultPeriod, List<KLinePeriod> referPeriods)
        {
            this.fac = fac;
            this.code = code;
