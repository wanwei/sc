...
namespace com.wer.sc.data.impl
{
    public abstract class KLineData_Abstract : KLineBar_Abstract, IKLineData
    {
        ...
        public IKLineBar GetAggrKLineBar(int startIndex, int endIndex)
        {
            ...
            chart.FullTime = this.Arr_Time[startIndex];
        ...
        public KLineData_RealTime GetRealTimeKLineData()
        {
            return new KLineData_RealTime(this);
        }
        ...
        public static String KLineToString(IKLineData klineData)
        {
            ...
            sb.Append(klineData.FullTime).Append(",");
        ...
        public IKLineBar GetKLineBar(int index)
        {
